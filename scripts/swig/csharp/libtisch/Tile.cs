...
public class Tile : Button {
  ...
  public Tile(int _w, int _h, int _x, int _y, double angle, RGBATexture _tex, int _mode) : this(libtischPINVOKE.new_Tile__SWIG_0(_w, _h, _x, _y, angle, RGBATexture.getCPtr(_tex), _mode), true) {
  }

  public Tile(int _w, int _h, int _x, int _y, double angle, RGBATexture _tex) : this(libtischPINVOKE.new_Tile__SWIG_1(_w, _h, _x, _y, angle, RGBATexture.getCPtr(_tex)), true) {
  }
  ...
  public override void action(Gesture gesture) {
    libtischPINVOKE.Tile_action(swigCPtr, Gesture.getCPtr(gesture));
  }

  public override void tap(Vector pos, int id) {
    libtischPINVOKE.Tile_tap(swigCPtr, Vector.getCPtr(pos), id);
