...
SWIGINTERN void std_vector_Sl_Vector_Sg__setitem(std::vector< Vector > *self,int index,std::vector< _Vector< double > >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_Vector_Sg__Insert(std::vector< Vector > *self,int index,std::vector< _Vector< double > >::value_type const &x){
...
SWIGINTERN std::vector< _Vector< double > > *std_vector_Sl_Vector_Sg__Repeat(std::vector< _Vector< double > >::value_type const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN void std_vector_Sl_BlobState_Sg__setitem(std::vector< BlobState > *self,int index,std::vector< BlobState >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_BlobState_Sg__Insert(std::vector< BlobState > *self,int index,std::vector< BlobState >::value_type const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
...
SWIGINTERN std::vector< BlobState > *std_vector_Sl_BlobState_Sg__Repeat(std::vector< BlobState >::value_type const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN void std_vector_Sl_SmartPtr_Sl_FeatureBase_Sg__Sg__setitem(std::vector< SmartPtr< FeatureBase > > *self,int index,std::vector< SmartPtr< FeatureBase > >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_SmartPtr_Sl_FeatureBase_Sg__Sg__Insert(std::vector< SmartPtr< FeatureBase > > *self,int index,std::vector< SmartPtr< FeatureBase > >::value_type const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
...
SWIGINTERN std::vector< SmartPtr< FeatureBase > > *std_vector_Sl_SmartPtr_Sl_FeatureBase_Sg__Sg__Repeat(std::vector< SmartPtr< FeatureBase > >::value_type const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN void std_vector_Sl_Gesture_Sg__setitem(std::vector< Gesture > *self,int index,std::vector< Gesture >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_Gesture_Sg__Insert(std::vector< Gesture > *self,int index,std::vector< Gesture >::value_type const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
...
SWIGINTERN std::vector< Gesture > *std_vector_Sl_Gesture_Sg__Repeat(std::vector< Gesture >::value_type const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN bool std_vector_Sl_int_Sg__Remove(std::vector< int > *self,std::vector< int >::value_type const &value){
        std::vector<int >::iterator it = std::find(self->begin(), self->end(), value);
        if (it != self->end()) {
          self->erase(it);
	  return true;
...
SWIGINTERN void std_vector_Sl_Dimensions_Sg__setitem(std::vector< Dimensions > *self,int index,std::vector< Dimensions >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_Dimensions_Sg__Insert(std::vector< Dimensions > *self,int index,std::vector< Dimensions >::value_type const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
...
SWIGINTERN std::vector< Dimensions > *std_vector_Sl_Dimensions_Sg__Repeat(std::vector< Dimensions >::value_type const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN void std_vector_Sl_double_Sg__setitem(std::vector< double > *self,int index,std::vector< double >::value_type const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_double_Sg__Insert(std::vector< double > *self,int index,std::vector< double >::value_type const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
...
SWIGINTERN bool std_vector_Sl_double_Sg__Remove(std::vector< double > *self,std::vector< double >::value_type const &value){
        std::vector<double >::iterator it = std::find(self->begin(), self->end(), value);
        if (it != self->end()) {
          self->erase(it);
	  return true;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorVector_Add(void * jarg1, void * jarg2) {
  std::vector< Vector > *arg1 = (std::vector< Vector > *) 0 ;
  std::vector< _Vector< double > >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< Vector > *)jarg1; 
  arg2 = (std::vector< _Vector< double > >::value_type *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< _Vector< double > >::value_type const & type is null", 0);
    return ;
  } 
  (arg1)->push_back((std::vector< _Vector< double > >::value_type const &)*arg2);
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorVector_getitem(void * jarg1, int jarg2) {
  ...
  std::vector< Vector > *arg1 = (std::vector< Vector > *) 0 ;
  int arg2 ;
  std::vector< _Vector< double > >::value_type *result = 0 ;
  
  arg1 = (std::vector< Vector > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< _Vector< double > >::value_type *) &std_vector_Sl_Vector_Sg__getitem(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorVector_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< Vector > *arg1 = (std::vector< Vector > *) 0 ;
  int arg2 ;
  std::vector< _Vector< double > >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< Vector > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< _Vector< double > >::value_type *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< _Vector< double > >::value_type const & type is null", 0);
    return ;
  } 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorVector_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< _Vector< double > >::value_type *arg1 = 0 ;
  int arg2 ;
  std::vector< _Vector< double > > *result = 0 ;
  
  arg1 = (std::vector< _Vector< double > >::value_type *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< _Vector< double > >::value_type const & type is null", 0);
    return 0;
  } 
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorBlobState_Add(void * jarg1, void * jarg2) {
  std::vector< BlobState > *arg1 = (std::vector< BlobState > *) 0 ;
  std::vector< BlobState >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< BlobState > *)jarg1; 
  arg2 = (std::vector< BlobState >::value_type *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< BlobState >::value_type const & type is null", 0);
    return ;
  } 
  (arg1)->push_back((std::vector< BlobState >::value_type const &)*arg2);
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorBlobState_getitem(void * jarg1, int jarg2) {
  ...
  std::vector< BlobState > *arg1 = (std::vector< BlobState > *) 0 ;
  int arg2 ;
  std::vector< BlobState >::value_type *result = 0 ;
  
  arg1 = (std::vector< BlobState > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< BlobState >::value_type *) &std_vector_Sl_BlobState_Sg__getitem(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorBlobState_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< BlobState > *arg1 = (std::vector< BlobState > *) 0 ;
  int arg2 ;
  std::vector< BlobState >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< BlobState > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< BlobState >::value_type *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< BlobState >::value_type const & type is null", 0);
    return ;
  } 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorBlobState_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< BlobState >::value_type *arg1 = 0 ;
  int arg2 ;
  std::vector< BlobState > *result = 0 ;
  
  arg1 = (std::vector< BlobState >::value_type *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< BlobState >::value_type const & type is null", 0);
    return 0;
  } 
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorSmartPtrFeatureBase_Add(void * jarg1, void * jarg2) {
  std::vector< SmartPtr< FeatureBase > > *arg1 = (std::vector< SmartPtr< FeatureBase > > *) 0 ;
  std::vector< SmartPtr< FeatureBase > >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< SmartPtr< FeatureBase > > *)jarg1; 
  arg2 = (std::vector< SmartPtr< FeatureBase > >::value_type *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< SmartPtr< FeatureBase > >::value_type const & type is null", 0);
    return ;
  } 
  (arg1)->push_back((std::vector< SmartPtr< FeatureBase > >::value_type const &)*arg2);
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorSmartPtrFeatureBase_getitem(void * jarg1, int jarg2) {
  ...
  std::vector< SmartPtr< FeatureBase > > *arg1 = (std::vector< SmartPtr< FeatureBase > > *) 0 ;
  int arg2 ;
  std::vector< SmartPtr< FeatureBase > >::value_type *result = 0 ;
  
  arg1 = (std::vector< SmartPtr< FeatureBase > > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< SmartPtr< FeatureBase > >::value_type *) &std_vector_Sl_SmartPtr_Sl_FeatureBase_Sg__Sg__getitem(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorSmartPtrFeatureBase_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< SmartPtr< FeatureBase > > *arg1 = (std::vector< SmartPtr< FeatureBase > > *) 0 ;
  int arg2 ;
  std::vector< SmartPtr< FeatureBase > >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< SmartPtr< FeatureBase > > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< SmartPtr< FeatureBase > >::value_type *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< SmartPtr< FeatureBase > >::value_type const & type is null", 0);
    return ;
  } 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorSmartPtrFeatureBase_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< SmartPtr< FeatureBase > >::value_type *arg1 = 0 ;
  int arg2 ;
  std::vector< SmartPtr< FeatureBase > > *result = 0 ;
  
  arg1 = (std::vector< SmartPtr< FeatureBase > >::value_type *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< SmartPtr< FeatureBase > >::value_type const & type is null", 0);
    return 0;
  } 
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorGesture_Add(void * jarg1, void * jarg2) {
  std::vector< Gesture > *arg1 = (std::vector< Gesture > *) 0 ;
  std::vector< Gesture >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< Gesture > *)jarg1; 
  arg2 = (std::vector< Gesture >::value_type *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Gesture >::value_type const & type is null", 0);
    return ;
  } 
  (arg1)->push_back((std::vector< Gesture >::value_type const &)*arg2);
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorGesture_getitem(void * jarg1, int jarg2) {
  ...
  std::vector< Gesture > *arg1 = (std::vector< Gesture > *) 0 ;
  int arg2 ;
  std::vector< Gesture >::value_type *result = 0 ;
  
  arg1 = (std::vector< Gesture > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< Gesture >::value_type *) &std_vector_Sl_Gesture_Sg__getitem(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorGesture_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< Gesture > *arg1 = (std::vector< Gesture > *) 0 ;
  int arg2 ;
  std::vector< Gesture >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< Gesture > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< Gesture >::value_type *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Gesture >::value_type const & type is null", 0);
    return ;
  } 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorGesture_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< Gesture >::value_type *arg1 = 0 ;
  int arg2 ;
  std::vector< Gesture > *result = 0 ;
  
  arg1 = (std::vector< Gesture >::value_type *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Gesture >::value_type const & type is null", 0);
    return 0;
  } 
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorDimensions_Add(void * jarg1, void * jarg2) {
  std::vector< Dimensions > *arg1 = (std::vector< Dimensions > *) 0 ;
  std::vector< Dimensions >::value_type *arg2 = 0 ;
  
  arg1 = (std::vector< Dimensions > *)jarg1; 
  arg2 = (std::vector< Dimensions >::value_type *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Dimensions >::value_type const & type is null", 0);
    return ;
  } 
  (arg1)->push_back((std::vector< Dimensions >::value_type const &)*arg2);
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorDimensions_getitem(void * jarg1, int jarg2) {
  ...
  std::vector< Dimensions > *arg1 = (std::vector< Dimensions > *) 0 ;
  int arg2 ;
  std::vector< Dimensions >::value_type *result = 0 ;
  
  arg1 = (std::vector< Dimensions > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< Dimensions >::value_type *) &std_vector_Sl_Dimensions_Sg__getitem(arg1,arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
...
SWIGEXPORT void SWIGSTDCALL CSharp_vectorDimensions_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< Dimensions > *arg1 = (std::vector< Dimensions > *) 0 ;
  int arg2 ;
  std::vector< Dimensions >::value_type *arg3 = 0 ;
  
  arg1 = (std::vector< Dimensions > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< Dimensions >::value_type *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Dimensions >::value_type const & type is null", 0);
    return ;
  } 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_vectorDimensions_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< Dimensions >::value_type *arg1 = 0 ;
  int arg2 ;
  std::vector< Dimensions > *result = 0 ;
  
  arg1 = (std::vector< Dimensions >::value_type *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< Dimensions >::value_type const & type is null", 0);
    return 0;
  } 
...
SWIGEXPORT int SWIGSTDCALL CSharp_GL_MAX_PROGRAM_TEXTURE_GATHER_COMPONENTS_get() {
  int jresult ;
  int result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_Widget_paint(void * jarg1) {
  Widget *arg1 = (Widget *) 0 ;
  SwigDirector_Widget *darg = 0;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Button__SWIG_0(int jarg1, int jarg2, int jarg3, int jarg4, double jarg5, void * jarg6) {
  ...
  arg5 = (double)jarg5; 
  arg6 = (RGBATexture *)jarg6; 
  result = (Button *)new Button(arg1,arg2,arg3,arg4,arg5,arg6);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Button__SWIG_1(int jarg1, int jarg2, int jarg3, int jarg4, double jarg5) {
  ...
  arg4 = (int)jarg4; 
  arg5 = (double)jarg5; 
  result = (Button *)new Button(arg1,arg2,arg3,arg4,arg5);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Button__SWIG_2(int jarg1, int jarg2, int jarg3, int jarg4) {
  ...
  arg3 = (int)jarg3; 
  arg4 = (int)jarg4; 
  result = (Button *)new Button(arg1,arg2,arg3,arg4);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Button__SWIG_3(int jarg1, int jarg2, int jarg3) {
  ...
  arg2 = (int)jarg2; 
  arg3 = (int)jarg3; 
  result = (Button *)new Button(arg1,arg2,arg3);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Button__SWIG_4(int jarg1, int jarg2) {
  ...
  arg1 = (int)jarg1; 
  arg2 = (int)jarg2; 
  result = (Button *)new Button(arg1,arg2);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Tile__SWIG_0(int jarg1, int jarg2, int jarg3, int jarg4, double jarg5, void * jarg6, int jarg7) {
  ...
  arg6 = (RGBATexture *)jarg6; 
  arg7 = (int)jarg7; 
  result = (Tile *)new Tile(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Tile__SWIG_1(int jarg1, int jarg2, int jarg3, int jarg4, double jarg5, void * jarg6) {
  ...
  arg5 = (double)jarg5; 
  arg6 = (RGBATexture *)jarg6; 
  result = (Tile *)new Tile(arg1,arg2,arg3,arg4,arg5,arg6);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Tile__SWIG_2(int jarg1, int jarg2, int jarg3, int jarg4, double jarg5) {
  ...
  arg4 = (int)jarg4; 
  arg5 = (double)jarg5; 
  result = (Tile *)new Tile(arg1,arg2,arg3,arg4,arg5);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Tile__SWIG_3(int jarg1, int jarg2, int jarg3, int jarg4) {
  ...
  arg3 = (int)jarg3; 
  arg4 = (int)jarg4; 
  result = (Tile *)new Tile(arg1,arg2,arg3,arg4);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Tile__SWIG_5(int jarg1, int jarg2) {
  ...
  arg1 = (int)jarg1; 
  arg2 = (int)jarg2; 
  result = (Tile *)new Tile(arg1,arg2);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void SWIGSTDCALL CSharp_Container_add(void * jarg1, void * jarg2) {
  Container *arg1 = (Container *) 0 ;
  Widget *arg2 = (Widget *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_Container_remove(void * jarg1, void * jarg2) {
  Container *arg1 = (Container *) 0 ;
  Widget *arg2 = (Widget *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_Container_director_connect(void *objarg, SwigDirector_Container::SWIG_Callback0_t callback0, SwigDirector_Container::SWIG_Callback1_t callback1, SwigDirector_Container::SWIG_Callback2_t callback2, SwigDirector_Container::SWIG_Callback3_t callback3, SwigDirector_Container::SWIG_Callback4_t callback4, SwigDirector_Container::SWIG_Callback5_t callback5, SwigDirector_Container::SWIG_Callback6_t callback6, SwigDirector_Container::SWIG_Callback7_t callback7, SwigDirector_Container::SWIG_Callback8_t callback8, SwigDirector_Container::SWIG_Callback9_t callback9, SwigDirector_Container::SWIG_Callback10_t callback10, SwigDirector_Container::SWIG_Callback11_t callback11) {
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_MasterContainer__SWIG_0(int jarg1, int jarg2, char * jarg3) {
  ...
  arg2 = (int)jarg2; 
  arg3 = (char *)jarg3; 
  result = (MasterContainer *)new MasterContainer(arg1,arg2,(char const *)arg3);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_MasterContainer__SWIG_1(int jarg1, int jarg2) {
  ...
  arg1 = (int)jarg1; 
  arg2 = (int)jarg2; 
  result = (MasterContainer *)new MasterContainer(arg1,arg2);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT std::deque< BasicBlob > * SWIGSTDCALL CSharp_BlobHistoryUpcast(BlobHistory *objectRef) {
    return (std::deque< BasicBlob > *)objectRef;
}

SWIGEXPORT std::map< int,BlobHistory > * SWIGSTDCALL CSharp_BlobStateUpcast(BlobState *objectRef) {
    return (std::map< int,BlobHistory > *)objectRef;
}

SWIGEXPORT std::vector< BlobState > * SWIGSTDCALL CSharp_InputStateUpcast(InputState *objectRef) {
    return (std::vector< BlobState > *)objectRef;
}

SWIGEXPORT std::vector< SmartPtr< FeatureBase > > * SWIGSTDCALL CSharp_GestureUpcast(Gesture *objectRef) {
    return (std::vector< SmartPtr< FeatureBase > > *)objectRef;
}

SWIGEXPORT std::vector< Vector > * SWIGSTDCALL CSharp_RegionUpcast(Region *objectRef) {
    return (std::vector< Vector > *)objectRef;
}

SWIGEXPORT Region * SWIGSTDCALL CSharp_StateRegionUpcast(StateRegion *objectRef) {
    return (Region *)objectRef;
}

SWIGEXPORT FeatureBase * SWIGSTDCALL CSharp_FeatureIntUpcast(Feature< int > *objectRef) {
    return (FeatureBase *)objectRef;
}

SWIGEXPORT Feature< int > * SWIGSTDCALL CSharp_BlobCountUpcast(BlobCount *objectRef) {
    return (Feature< int > *)objectRef;
}

SWIGEXPORT FeatureBase * SWIGSTDCALL CSharp_FeatureDimensionsUpcast(Feature< Dimensions > *objectRef) {
    return (FeatureBase *)objectRef;
}

SWIGEXPORT Feature< Dimensions > * SWIGSTDCALL CSharp_BlobDimUpcast(BlobDim *objectRef) {
    return (Feature< Dimensions > *)objectRef;
}

SWIGEXPORT Feature< int > * SWIGSTDCALL CSharp_BlobIDUpcast(BlobID *objectRef) {
    return (Feature< int > *)objectRef;
}

SWIGEXPORT FeatureBase * SWIGSTDCALL CSharp_FeatureVectorUpcast(Feature< Vector > *objectRef) {
    return (FeatureBase *)objectRef;
}

SWIGEXPORT Feature< Vector > * SWIGSTDCALL CSharp_BlobPosUpcast(BlobPos *objectRef) {
    return (Feature< Vector > *)objectRef;
}

SWIGEXPORT Feature< Vector > * SWIGSTDCALL CSharp_BlobGroupUpcast(BlobGroup *objectRef) {
    return (Feature< Vector > *)objectRef;
}

SWIGEXPORT FeatureBase * SWIGSTDCALL CSharp_FeatureDoubleUpcast(Feature< double > *objectRef) {
    return (FeatureBase *)objectRef;
}

SWIGEXPORT Feature< Vector > * SWIGSTDCALL CSharp_MotionUpcast(Motion *objectRef) {
    return (Feature< Vector > *)objectRef;
}

SWIGEXPORT Feature< double > * SWIGSTDCALL CSharp_RotationUpcast(Rotation *objectRef) {
    return (Feature< double > *)objectRef;
}

SWIGEXPORT Feature< double > * SWIGSTDCALL CSharp_ScaleUpcast(Scale *objectRef) {
    return (Feature< double > *)objectRef;
}

SWIGEXPORT Scale * SWIGSTDCALL CSharp_MultiBlobScaleUpcast(MultiBlobScale *objectRef) {
    return (Scale *)objectRef;
}

SWIGEXPORT Widget * SWIGSTDCALL CSharp_ButtonUpcast(Button *objectRef) {
    return (Widget *)objectRef;
}

SWIGEXPORT Button * SWIGSTDCALL CSharp_TileUpcast(Tile *objectRef) {
    return (Button *)objectRef;
}

SWIGEXPORT Tile * SWIGSTDCALL CSharp_ContainerUpcast(Container *objectRef) {
    return (Tile *)objectRef;
}

SWIGEXPORT Container * SWIGSTDCALL CSharp_MasterContainerUpcast(MasterContainer *objectRef) {
    return (Container *)objectRef;
}
