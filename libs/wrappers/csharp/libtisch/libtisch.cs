...
public class libtisch {
  public static SWIGTYPE_p_std__istream read_from(SWIGTYPE_p_std__istream s, BasicBlob b) {
    SWIGTYPE_p_std__istream ret = new SWIGTYPE_p_std__istream(libtischPINVOKE.read_from__SWIG_2(SWIGTYPE_p_std__istream.getCPtr(s), BasicBlob.getCPtr(b)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static SWIGTYPE_p_std__ostream write_to(SWIGTYPE_p_std__ostream s, BasicBlob b) {
    SWIGTYPE_p_std__ostream ret = new SWIGTYPE_p_std__ostream(libtischPINVOKE.write_to__SWIG_3(SWIGTYPE_p_std__ostream.getCPtr(s), BasicBlob.getCPtr(b)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static SWIGTYPE_p_std__istream read_from(SWIGTYPE_p_std__istream s, Gesture g) {
    SWIGTYPE_p_std__istream ret = new SWIGTYPE_p_std__istream(libtischPINVOKE.read_from__SWIG_3(SWIGTYPE_p_std__istream.getCPtr(s), Gesture.getCPtr(g)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static SWIGTYPE_p_std__ostream write_to(SWIGTYPE_p_std__ostream s, Gesture g) {
    SWIGTYPE_p_std__ostream ret = new SWIGTYPE_p_std__ostream(libtischPINVOKE.write_to__SWIG_4(SWIGTYPE_p_std__ostream.getCPtr(s), Gesture.getCPtr(g)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static SWIGTYPE_p_std__istream read_from(SWIGTYPE_p_std__istream s, Region r) {
    SWIGTYPE_p_std__istream ret = new SWIGTYPE_p_std__istream(libtischPINVOKE.read_from__SWIG_4(SWIGTYPE_p_std__istream.getCPtr(s), Region.getCPtr(r)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static SWIGTYPE_p_std__ostream write_to(SWIGTYPE_p_std__ostream s, Region r) {
    SWIGTYPE_p_std__ostream ret = new SWIGTYPE_p_std__ostream(libtischPINVOKE.write_to__SWIG_5(SWIGTYPE_p_std__ostream.getCPtr(s), Region.getCPtr(r)), false);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static readonly int GL_UNPACK_COMPRESSED_BLOCK_WIDTH = libtischPINVOKE.GL_UNPACK_COMPRESSED_BLOCK_WIDTH_get();
  public static readonly int GL_UNPACK_COMPRESSED_BLOCK_HEIGHT = libtischPINVOKE.GL_UNPACK_COMPRESSED_BLOCK_HEIGHT_get();
  public static readonly int GL_UNPACK_COMPRESSED_BLOCK_DEPTH = libtischPINVOKE.GL_UNPACK_COMPRESSED_BLOCK_DEPTH_get();
  public static readonly int GL_UNPACK_COMPRESSED_BLOCK_SIZE = libtischPINVOKE.GL_UNPACK_COMPRESSED_BLOCK_SIZE_get();
  public static readonly int GL_PACK_COMPRESSED_BLOCK_WIDTH = libtischPINVOKE.GL_PACK_COMPRESSED_BLOCK_WIDTH_get();
  public static readonly int GL_PACK_COMPRESSED_BLOCK_HEIGHT = libtischPINVOKE.GL_PACK_COMPRESSED_BLOCK_HEIGHT_get();
  public static readonly int GL_PACK_COMPRESSED_BLOCK_DEPTH = libtischPINVOKE.GL_PACK_COMPRESSED_BLOCK_DEPTH_get();
  public static readonly int GL_PACK_COMPRESSED_BLOCK_SIZE = libtischPINVOKE.GL_PACK_COMPRESSED_BLOCK_SIZE_get();
  public static readonly int GL_NUM_SAMPLE_COUNTS = libtischPINVOKE.GL_NUM_SAMPLE_COUNTS_get();
  public static readonly int GL_MIN_MAP_BUFFER_ALIGNMENT = libtischPINVOKE.GL_MIN_MAP_BUFFER_ALIGNMENT_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_BINDING = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_BINDING_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_START = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_START_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_SIZE = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_SIZE_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_DATA_SIZE = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_DATA_SIZE_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTERS = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTERS_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_VERTEX_SHADER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_VERTEX_SHADER_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_GEOMETRY_SHADER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_GEOMETRY_SHADER_get();
  public static readonly int GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_FRAGMENT_SHADER = libtischPINVOKE.GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_FRAGMENT_SHADER_get();
  public static readonly int GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_MAX_VERTEX_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_VERTEX_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_GEOMETRY_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_GEOMETRY_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_FRAGMENT_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_FRAGMENT_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_COMBINED_ATOMIC_COUNTERS = libtischPINVOKE.GL_MAX_COMBINED_ATOMIC_COUNTERS_get();
  public static readonly int GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE = libtischPINVOKE.GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE_get();
  public static readonly int GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS = libtischPINVOKE.GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS_get();
  public static readonly int GL_ACTIVE_ATOMIC_COUNTER_BUFFERS = libtischPINVOKE.GL_ACTIVE_ATOMIC_COUNTER_BUFFERS_get();
  public static readonly int GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX = libtischPINVOKE.GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX_get();
  public static readonly int GL_UNSIGNED_INT_ATOMIC_COUNTER = libtischPINVOKE.GL_UNSIGNED_INT_ATOMIC_COUNTER_get();
  public static readonly int GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT = libtischPINVOKE.GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_get();
  public static readonly int GL_ELEMENT_ARRAY_BARRIER_BIT = libtischPINVOKE.GL_ELEMENT_ARRAY_BARRIER_BIT_get();
  public static readonly int GL_UNIFORM_BARRIER_BIT = libtischPINVOKE.GL_UNIFORM_BARRIER_BIT_get();
  public static readonly int GL_TEXTURE_FETCH_BARRIER_BIT = libtischPINVOKE.GL_TEXTURE_FETCH_BARRIER_BIT_get();
  public static readonly int GL_SHADER_IMAGE_ACCESS_BARRIER_BIT = libtischPINVOKE.GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_get();
  public static readonly int GL_COMMAND_BARRIER_BIT = libtischPINVOKE.GL_COMMAND_BARRIER_BIT_get();
  public static readonly int GL_PIXEL_BUFFER_BARRIER_BIT = libtischPINVOKE.GL_PIXEL_BUFFER_BARRIER_BIT_get();
  public static readonly int GL_TEXTURE_UPDATE_BARRIER_BIT = libtischPINVOKE.GL_TEXTURE_UPDATE_BARRIER_BIT_get();
  public static readonly int GL_BUFFER_UPDATE_BARRIER_BIT = libtischPINVOKE.GL_BUFFER_UPDATE_BARRIER_BIT_get();
  public static readonly int GL_FRAMEBUFFER_BARRIER_BIT = libtischPINVOKE.GL_FRAMEBUFFER_BARRIER_BIT_get();
  public static readonly int GL_TRANSFORM_FEEDBACK_BARRIER_BIT = libtischPINVOKE.GL_TRANSFORM_FEEDBACK_BARRIER_BIT_get();
  public static readonly int GL_ATOMIC_COUNTER_BARRIER_BIT = libtischPINVOKE.GL_ATOMIC_COUNTER_BARRIER_BIT_get();
  public static readonly int GL_ALL_BARRIER_BITS = libtischPINVOKE.GL_ALL_BARRIER_BITS_get();
  public static readonly int GL_MAX_IMAGE_UNITS = libtischPINVOKE.GL_MAX_IMAGE_UNITS_get();
  public static readonly int GL_MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS = libtischPINVOKE.GL_MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS_get();
  public static readonly int GL_IMAGE_BINDING_NAME = libtischPINVOKE.GL_IMAGE_BINDING_NAME_get();
  public static readonly int GL_IMAGE_BINDING_LEVEL = libtischPINVOKE.GL_IMAGE_BINDING_LEVEL_get();
  public static readonly int GL_IMAGE_BINDING_LAYERED = libtischPINVOKE.GL_IMAGE_BINDING_LAYERED_get();
  public static readonly int GL_IMAGE_BINDING_LAYER = libtischPINVOKE.GL_IMAGE_BINDING_LAYER_get();
  public static readonly int GL_IMAGE_BINDING_ACCESS = libtischPINVOKE.GL_IMAGE_BINDING_ACCESS_get();
  public static readonly int GL_IMAGE_1D = libtischPINVOKE.GL_IMAGE_1D_get();
  public static readonly int GL_IMAGE_2D = libtischPINVOKE.GL_IMAGE_2D_get();
  public static readonly int GL_IMAGE_3D = libtischPINVOKE.GL_IMAGE_3D_get();
  public static readonly int GL_IMAGE_2D_RECT = libtischPINVOKE.GL_IMAGE_2D_RECT_get();
  public static readonly int GL_IMAGE_CUBE = libtischPINVOKE.GL_IMAGE_CUBE_get();
  public static readonly int GL_IMAGE_BUFFER = libtischPINVOKE.GL_IMAGE_BUFFER_get();
  public static readonly int GL_IMAGE_1D_ARRAY = libtischPINVOKE.GL_IMAGE_1D_ARRAY_get();
  public static readonly int GL_IMAGE_2D_ARRAY = libtischPINVOKE.GL_IMAGE_2D_ARRAY_get();
  public static readonly int GL_IMAGE_CUBE_MAP_ARRAY = libtischPINVOKE.GL_IMAGE_CUBE_MAP_ARRAY_get();
  public static readonly int GL_IMAGE_2D_MULTISAMPLE = libtischPINVOKE.GL_IMAGE_2D_MULTISAMPLE_get();
  public static readonly int GL_IMAGE_2D_MULTISAMPLE_ARRAY = libtischPINVOKE.GL_IMAGE_2D_MULTISAMPLE_ARRAY_get();
  public static readonly int GL_INT_IMAGE_1D = libtischPINVOKE.GL_INT_IMAGE_1D_get();
  public static readonly int GL_INT_IMAGE_2D = libtischPINVOKE.GL_INT_IMAGE_2D_get();
  public static readonly int GL_INT_IMAGE_3D = libtischPINVOKE.GL_INT_IMAGE_3D_get();
  public static readonly int GL_INT_IMAGE_2D_RECT = libtischPINVOKE.GL_INT_IMAGE_2D_RECT_get();
  public static readonly int GL_INT_IMAGE_CUBE = libtischPINVOKE.GL_INT_IMAGE_CUBE_get();
  public static readonly int GL_INT_IMAGE_BUFFER = libtischPINVOKE.GL_INT_IMAGE_BUFFER_get();
  public static readonly int GL_INT_IMAGE_1D_ARRAY = libtischPINVOKE.GL_INT_IMAGE_1D_ARRAY_get();
  public static readonly int GL_INT_IMAGE_2D_ARRAY = libtischPINVOKE.GL_INT_IMAGE_2D_ARRAY_get();
  public static readonly int GL_INT_IMAGE_CUBE_MAP_ARRAY = libtischPINVOKE.GL_INT_IMAGE_CUBE_MAP_ARRAY_get();
  public static readonly int GL_INT_IMAGE_2D_MULTISAMPLE = libtischPINVOKE.GL_INT_IMAGE_2D_MULTISAMPLE_get();
  public static readonly int GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY = libtischPINVOKE.GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_1D = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_1D_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_2D = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_2D_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_3D = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_3D_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_2D_RECT = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_2D_RECT_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_CUBE = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_CUBE_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_BUFFER = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_BUFFER_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_1D_ARRAY = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_1D_ARRAY_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_2D_ARRAY = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_2D_ARRAY_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_get();
  public static readonly int GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY = libtischPINVOKE.GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY_get();
  public static readonly int GL_MAX_IMAGE_SAMPLES = libtischPINVOKE.GL_MAX_IMAGE_SAMPLES_get();
  public static readonly int GL_IMAGE_BINDING_FORMAT = libtischPINVOKE.GL_IMAGE_BINDING_FORMAT_get();
  public static readonly int GL_IMAGE_FORMAT_COMPATIBILITY_TYPE = libtischPINVOKE.GL_IMAGE_FORMAT_COMPATIBILITY_TYPE_get();
  public static readonly int GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE = libtischPINVOKE.GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE_get();
  public static readonly int GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS = libtischPINVOKE.GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS_get();
  public static readonly int GL_MAX_VERTEX_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_VERTEX_IMAGE_UNIFORMS_get();
  public static readonly int GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS_get();
  public static readonly int GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS_get();
  public static readonly int GL_MAX_GEOMETRY_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_GEOMETRY_IMAGE_UNIFORMS_get();
  public static readonly int GL_MAX_FRAGMENT_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_FRAGMENT_IMAGE_UNIFORMS_get();
  public static readonly int GL_MAX_COMBINED_IMAGE_UNIFORMS = libtischPINVOKE.GL_MAX_COMBINED_IMAGE_UNIFORMS_get();
  public static readonly int GL_TEXTURE_IMMUTABLE_FORMAT = libtischPINVOKE.GL_TEXTURE_IMMUTABLE_FORMAT_get();
  ...
  public static readonly int GL_VERSION_4_2 = libtischPINVOKE.GL_VERSION_4_2_get();
  ...
  public static readonly int GL_ARB_shader_bit_encoding = libtischPINVOKE.GL_ARB_shader_bit_encoding_get();
  ...
  public static readonly int GL_ARB_base_instance = libtischPINVOKE.GL_ARB_base_instance_get();
  public static readonly int GL_ARB_shading_language_420pack = libtischPINVOKE.GL_ARB_shading_language_420pack_get();
  public static readonly int GL_ARB_transform_feedback_instanced = libtischPINVOKE.GL_ARB_transform_feedback_instanced_get();
  public static readonly int GL_ARB_compressed_texture_pixel_storage = libtischPINVOKE.GL_ARB_compressed_texture_pixel_storage_get();
  public static readonly int GL_ARB_conservative_depth = libtischPINVOKE.GL_ARB_conservative_depth_get();
  public static readonly int GL_ARB_internalformat_query = libtischPINVOKE.GL_ARB_internalformat_query_get();
  public static readonly int GL_ARB_map_buffer_alignment = libtischPINVOKE.GL_ARB_map_buffer_alignment_get();
  public static readonly int GL_ARB_shader_atomic_counters = libtischPINVOKE.GL_ARB_shader_atomic_counters_get();
  public static readonly int GL_ARB_shader_image_load_store = libtischPINVOKE.GL_ARB_shader_image_load_store_get();
  public static readonly int GL_ARB_shading_language_packing = libtischPINVOKE.GL_ARB_shading_language_packing_get();
  public static readonly int GL_ARB_texture_storage = libtischPINVOKE.GL_ARB_texture_storage_get();
