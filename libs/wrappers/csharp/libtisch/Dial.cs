...
public class Dial : Widget {
  ...
  internal Dial(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.Dial_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void draw() {
    if (SwigDerivedClassHasMethod("draw", swigMethodTypes9)) libtischPINVOKE.Dial_drawSwigExplicitDial(swigCPtr); else libtischPINVOKE.Dial_draw(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void action(Gesture gesture) {
    if (SwigDerivedClassHasMethod("action", swigMethodTypes10)) libtischPINVOKE.Dial_actionSwigExplicitDial(swigCPtr, Gesture.getCPtr(gesture)); else libtischPINVOKE.Dial_action(swigCPtr, Gesture.getCPtr(gesture));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void outline() {
    if (SwigDerivedClassHasMethod("outline", swigMethodTypes0)) libtischPINVOKE.Dial_outlineSwigExplicitDial(swigCPtr); else libtischPINVOKE.Dial_outline(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
