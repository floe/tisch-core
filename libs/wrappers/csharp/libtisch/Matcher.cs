...
public class Matcher : IDisposable {
  ...
  public virtual void prepare_updates() {
    libtischPINVOKE.Matcher_prepare_updates(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void process_updates() {
    libtischPINVOKE.Matcher_process_updates(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void prepare_gestures() {
    libtischPINVOKE.Matcher_prepare_gestures(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool has_input_data() {
    bool ret = libtischPINVOKE.Matcher_has_input_data(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
