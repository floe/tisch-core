...
public class MasterContainer : Container {
  ...
  internal MasterContainer(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.MasterContainer_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void doUpdate(Widget target) {
    if (SwigDerivedClassHasMethod("doUpdate", swigMethodTypes3)) libtischPINVOKE.MasterContainer_doUpdateSwigExplicitMasterContainer__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target)); else libtischPINVOKE.MasterContainer_doUpdate__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void doUpdate() {
    if (SwigDerivedClassHasMethod("doUpdate", swigMethodTypes4)) libtischPINVOKE.MasterContainer_doUpdateSwigExplicitMasterContainer__SWIG_1(swigCPtr); else libtischPINVOKE.MasterContainer_doUpdate__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool process_gestures() {
    bool ret = libtischPINVOKE.MasterContainer_process_gestures(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
