...
public class Tile : Button {
  ...
  internal Tile(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.Tile_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void action(Gesture gesture) {
    if (SwigDerivedClassHasMethod("action", swigMethodTypes10)) libtischPINVOKE.Tile_actionSwigExplicitTile(swigCPtr, Gesture.getCPtr(gesture)); else libtischPINVOKE.Tile_action(swigCPtr, Gesture.getCPtr(gesture));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void tap(Vector pos, int id) {
    if (SwigDerivedClassHasMethod("tap", swigMethodTypes15)) libtischPINVOKE.Tile_tapSwigExplicitTile(swigCPtr, Vector.getCPtr(pos), id); else libtischPINVOKE.Tile_tap(swigCPtr, Vector.getCPtr(pos), id);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void paint(bool update_stencil) {
    if (SwigDerivedClassHasMethod("paint", swigMethodTypes13)) libtischPINVOKE.Tile_paintSwigExplicitTile__SWIG_0(swigCPtr, update_stencil); else libtischPINVOKE.Tile_paint__SWIG_0(swigCPtr, update_stencil);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void paint() {
    if (SwigDerivedClassHasMethod("paint", swigMethodTypes14)) libtischPINVOKE.Tile_paintSwigExplicitTile__SWIG_1(swigCPtr); else libtischPINVOKE.Tile_paint__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void apply(Vector delta) {
    if (SwigDerivedClassHasMethod("apply", swigMethodTypes17)) libtischPINVOKE.Tile_applySwigExplicitTile(swigCPtr, Vector.getCPtr(delta)); else libtischPINVOKE.Tile_apply(swigCPtr, Vector.getCPtr(delta));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
