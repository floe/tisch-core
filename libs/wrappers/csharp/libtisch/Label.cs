...
public class Label : Widget {
  ...
  internal Label(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.Label_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void draw() {
    if (SwigDerivedClassHasMethod("draw", swigMethodTypes9)) libtischPINVOKE.Label_drawSwigExplicitLabel(swigCPtr); else libtischPINVOKE.Label_draw(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void action(Gesture gesture) {
    if (SwigDerivedClassHasMethod("action", swigMethodTypes10)) libtischPINVOKE.Label_actionSwigExplicitLabel(swigCPtr, Gesture.getCPtr(gesture)); else libtischPINVOKE.Label_action(swigCPtr, Gesture.getCPtr(gesture));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
