...
public class Container : Tile {
  ...
  internal Container(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.Container_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void raise(Widget widget) {
    if (SwigDerivedClassHasMethod("raise", swigMethodTypes5)) libtischPINVOKE.Container_raiseSwigExplicitContainer__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(widget)); else libtischPINVOKE.Container_raise__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(widget));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void raise() {
    if (SwigDerivedClassHasMethod("raise", swigMethodTypes6)) libtischPINVOKE.Container_raiseSwigExplicitContainer__SWIG_1(swigCPtr); else libtischPINVOKE.Container_raise__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void lower(Widget widget) {
    if (SwigDerivedClassHasMethod("lower", swigMethodTypes7)) libtischPINVOKE.Container_lowerSwigExplicitContainer__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(widget)); else libtischPINVOKE.Container_lower__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(widget));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void lower() {
    if (SwigDerivedClassHasMethod("lower", swigMethodTypes8)) libtischPINVOKE.Container_lowerSwigExplicitContainer__SWIG_1(swigCPtr); else libtischPINVOKE.Container_lower__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override void draw() {
    if (SwigDerivedClassHasMethod("draw", swigMethodTypes9)) libtischPINVOKE.Container_drawSwigExplicitContainer(swigCPtr); else libtischPINVOKE.Container_draw(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void paint(bool update_stencil) {
    if (SwigDerivedClassHasMethod("paint", swigMethodTypes13)) libtischPINVOKE.Container_paintSwigExplicitContainer__SWIG_0(swigCPtr, update_stencil); else libtischPINVOKE.Container_paint__SWIG_0(swigCPtr, update_stencil);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void paint() {
    if (SwigDerivedClassHasMethod("paint", swigMethodTypes14)) libtischPINVOKE.Container_paintSwigExplicitContainer__SWIG_1(swigCPtr); else libtischPINVOKE.Container_paint__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void doUpdate(Widget target) {
    if (SwigDerivedClassHasMethod("doUpdate", swigMethodTypes3)) libtischPINVOKE.Container_doUpdateSwigExplicitContainer__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target)); else libtischPINVOKE.Container_doUpdate__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void doUpdate() {
    if (SwigDerivedClassHasMethod("doUpdate", swigMethodTypes4)) libtischPINVOKE.Container_doUpdateSwigExplicitContainer__SWIG_1(swigCPtr); else libtischPINVOKE.Container_doUpdate__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void tap(Vector vec, int id) {
    if (SwigDerivedClassHasMethod("tap", swigMethodTypes15)) libtischPINVOKE.Container_tapSwigExplicitContainer(swigCPtr, Vector.getCPtr(vec), id); else libtischPINVOKE.Container_tap(swigCPtr, Vector.getCPtr(vec), id);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
