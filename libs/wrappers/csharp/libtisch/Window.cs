...
public class Window : GLUTWindow {
  ...
  internal Window(IntPtr cPtr, bool cMemoryOwn) : base(libtischPINVOKE.Window_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void idle() {
    if (SwigDerivedClassHasMethod("idle", swigMethodTypes0)) libtischPINVOKE.Window_idleSwigExplicitWindow(swigCPtr); else libtischPINVOKE.Window_idle(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void display() {
    if (SwigDerivedClassHasMethod("display", swigMethodTypes1)) libtischPINVOKE.Window_displaySwigExplicitWindow(swigCPtr); else libtischPINVOKE.Window_display(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void reshape(int w, int h) {
    if (SwigDerivedClassHasMethod("reshape", swigMethodTypes2)) libtischPINVOKE.Window_reshapeSwigExplicitWindow(swigCPtr, w, h); else libtischPINVOKE.Window_reshape(swigCPtr, w, h);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void keyboard(int key, int x, int y) {
    if (SwigDerivedClassHasMethod("keyboard", swigMethodTypes3)) libtischPINVOKE.Window_keyboardSwigExplicitWindow(swigCPtr, key, x, y); else libtischPINVOKE.Window_keyboard(swigCPtr, key, x, y);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void mouse(int num, int button, int state, int x, int y) {
    if (SwigDerivedClassHasMethod("mouse", swigMethodTypes4)) libtischPINVOKE.Window_mouseSwigExplicitWindow(swigCPtr, num, button, state, x, y); else libtischPINVOKE.Window_mouse(swigCPtr, num, button, state, x, y);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void motion(int num, int x, int y) {
    if (SwigDerivedClassHasMethod("motion", swigMethodTypes6)) libtischPINVOKE.Window_motionSwigExplicitWindow(swigCPtr, num, x, y); else libtischPINVOKE.Window_motion(swigCPtr, num, x, y);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void passive(int num, int x, int y) {
    if (SwigDerivedClassHasMethod("passive", swigMethodTypes5)) libtischPINVOKE.Window_passiveSwigExplicitWindow(swigCPtr, num, x, y); else libtischPINVOKE.Window_passive(swigCPtr, num, x, y);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public override void entry(int num, int state) {
    if (SwigDerivedClassHasMethod("entry", swigMethodTypes7)) libtischPINVOKE.Window_entrySwigExplicitWindow(swigCPtr, num, state); else libtischPINVOKE.Window_entry(swigCPtr, num, state);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public new void update(Widget target) {
    if (SwigDerivedClassHasMethod("update", swigMethodTypes8)) libtischPINVOKE.Window_updateSwigExplicitWindow__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target)); else libtischPINVOKE.Window_update__SWIG_0(swigCPtr, libtischPINVOKE.getCPtrAddRef(target));
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }

  public new void update() {
    if (SwigDerivedClassHasMethod("update", swigMethodTypes9)) libtischPINVOKE.Window_updateSwigExplicitWindow__SWIG_1(swigCPtr); else libtischPINVOKE.Window_update__SWIG_1(swigCPtr);
    if (libtischPINVOKE.SWIGPendingException.Pending) throw libtischPINVOKE.SWIGPendingException.Retrieve();
  }
