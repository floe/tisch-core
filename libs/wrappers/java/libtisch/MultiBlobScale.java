...
public class MultiBlobScale extends Scale {
  ...
  public MultiBlobScale(long cPtr, boolean cMemoryOwn) {
    super(libtischJNI.MultiBlobScale_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(MultiBlobScale obj) {
