...
public class MasterContainer extends Container {
  ...
  public MasterContainer(long cPtr, boolean cMemoryOwn) {
    super(libtischJNI.MasterContainer_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(MasterContainer obj) {
  ...
  public boolean process_gestures() {
